      ...
      <div class="container-fluid mb-2">
          ...
          <div class="bg-white p-4 p-md-5 rounded-3">
            <div class="row g-4">
              ...
              <div class="col-md-6">
                ...
                <div class="mb-1 border-bottom pb-1">
                  <div class="row align-items-center">
                    <label for="artist" class="col-sm-3 col-form-label text-primary">Type</label>
                    <div class="col-sm-9">
                      <input
                        type="text"
                        id="artist"
                ...
                <div class="mb-1 border-bottom pb-1">
                  <div class="row align-items-center">
                    <label for="genre" class="col-sm-3 col-form-label text-muted">Start date</label>
                    <div class="col-sm-9">
                      <input
                        type="text"
                        id="genre"
              ...
              <div class="col-md-6">
                <div class="mb-1 border-bottom pb-1">
                  <div class="row align-items-center">
                    <label for="album" class="col-sm-3 col-form-label text-muted">Amount</label>
                    <div class="col-sm-9">
                      <input
                        type="text"
                        id="album"
                ...
                <div class="mb-1 border-bottom pb-1">
                  <div class="row align-items-center">
                    <label for="label" class="col-sm-3 col-form-label text-primary">End date</label>
                    <div class="col-sm-9">
                      <input
                        type="text"
                        id="label"
        ...
        <div class="card">
          <ul class="nav nav-underline p-3">
            <li class="nav-item">
              <RouterLink to="/contract-detail">
                <a class="nav-link active" aria-current="page" href="">CONTRACT DETAIL</a>
              </RouterLink>
            </li>
            <li class="nav-item">
              <RouterLink to="/contract-royalty">
                <a class="nav-link" aria-current="page">ROYALTY</a>
              </RouterLink>
            </li>
            <li class="nav-item">
              <RouterLink to="/contract-approval">
                <a class="nav-link" aria-current="page" href="">APPROVALS</a>
              </RouterLink>
            </li>
            <li class="nav-item">
              <RouterLink to="/contract-attach">
          ...
          <div class="container-fluid">
            <div class="card-body">
              <div class="d-flex">
                <button type="button" class="btn btn-outline-primary">Asset Contract +</button>
                <div class="dropdown">
                  <button
                    class="btn btn-outline-primary dropdown-toggle"
                    type="button"
              ...
              <table class="table">
                ...
                <tbody>
                  <tr>
                    <td>
                        <RouterLink to="/asset-detail">Aku Harus Pergi</RouterLink>
                    </td>
                    <td>201</td>
                    <td>12/12/2020</td>
                    <td>12/12/2030</td>
