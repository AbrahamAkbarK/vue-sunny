                              ...
                              <tr>
                                ...
                                <td>
                                  <div class="d-flex flex-column gap-1">
                                    <span class="fw-medium"
                                      >Trial Sales
                                      <span class="badge bg-danger">Expired</span></span
                                    >
                                    <span class="text-muted"
                                      >RbL0b-32025-08101-82403-087yK-BKZGo</span
                                    >
                                  </div>
                                </td>
                                <td>
                                ...
                                <td>
                                  <div class="d-flex flex-column gap-1">
                                    ...
                                    <span class="text-muted">Expired 4 day ago</span>
                                  </div>
                                </td>
                                <td>
                                  <div class="d-flex flex-column gap-1">
                                    <span class="fw-medium">License: 1/3 used</span>
                                    <div class="d-flex align-items-center gap-1">
                                      <div
                                        class="progress progress-md progress-animated"
                                        role="progressbar"
                                        aria-valuenow="33"
                                        aria-valuemin="0"
                                        aria-valuemax="100"
                                    ...
                                    <span class="fw-medium text-success">2 license available</span>
                                  </div>
                                </td>
                              </tr>
                            </tbody>
