...
// Function to fetch the song data from the API
...
<template>
  <div class="container">
    ...
    <div class="main-content">
      ...
      <div v-else-if="song" class="container-fluid mb-2">
        <div class="card card-custom">
          <div class="card-header bg-white border-0">
            <h1>{{ song.title }}</h1>
            <div class="d-flex justify-content-between mb-2">
              <div class="d-flex">
                <RouterLink to="/asset-list">
          ...
          <div class="bg-white p-4 p-md-5 rounded-3">
            <div class="row g-4">
              ...
              <div class="col-md-6">
                <div class="mb-2 border-bottom pb-2">
                  <div class="row align-items-center">
                    <label for="title" class="col-sm-3 col-form-label text-muted"
                ...
                <div class="mb-2 border-bottom pb-2">
                  <div class="row align-items-center">
                    <label for="artist" class="col-sm-3 col-form-label text-primary">Artist</label>
                    <div class="col-sm-9">
                ...
                <div class="mb-2 border-bottom pb-2">
                  <div class="row align-items-center">
                    <label for="genre" class="col-sm-3 col-form-label text-muted">Genre</label>
                    <div class="col-sm-9">
                ...
                <div class="mb-2 border-bottom pb-2">
                  <div class="row align-items-center">
                    <label for="date-expired" class="col-sm-3 col-form-label text-muted"
                      >Date Expired</label
                    >
                    <div class="col-sm-9">
              ...
              <div class="col-md-6">
                <div class="mb-2 border-bottom pb-2">
                  <div class="row align-items-center">
                    <label for="album" class="col-sm-3 col-form-label text-muted">Album</label>
                    <div class="col-sm-9">
                ...
                <div class="mb-2 border-bottom pb-2">
                  <div class="row align-items-center">
                    <label for="composer" class="col-sm-3 col-form-label text-primary"
                      >Composer</label
                    >
                    <div class="col-sm-9">
                      <span>{{ song.composer.name }}</span>
                    </div>
                  </div>
                </div>
                <div class="mb-2 border-bottom pb-2">
                  <div class="row align-items-center">
                    <label for="label" class="col-sm-3 col-form-label text-primary">Label</label>
                    <div class="col-sm-9">
                ...
                <div class="mb-2 border-bottom pb-2">
                  <div class="row align-items-center">
                    <label for="master" class="col-sm-3 col-form-label text-primary">Master</label>
                    <div class="col-sm-9">
                      <span>{{ song.label }}</span>
                    </div>
                  </div>
          ...
          <ul class="nav nav-underline p-3">
            <li class="nav-item">
              <RouterLink to="/asset-detail">
                <a class="nav-link active" aria-current="page" href="">GENERAL INFORMATION</a>
              </RouterLink>
            </li>
            <li class="nav-item">
          ...
          <div class="bg-white p-4 p-md-5 rounded-3">
            <div class="row g-4">
              ...
              <div class="col-md-6">
                <div class="mb-2 border-bottom pb-2">
                  <div class="row align-items-center">
                    <label for="title" class="col-sm-3 col-form-label text-muted">ISRC</label>
                    <div class="col-sm-9">
                      <span>{{ song.isrc_code }}</span>
                    </div>
                  </div>
                </div>
                <div class="mb-2 border-bottom pb-2">
                  <div class="row align-items-center">
                    <label for="artist" class="col-sm-3 col-form-label text-muted"
                      >FEATURED/WITH</label
                    >
                    <div class="col-sm-9">
                      <span></span>
                ...
                <div class="mb-2 border-bottom pb-2">
                  <div class="row align-items-center">
                    <label for="genre" class="col-sm-3 col-form-label text-muted"
                      >Number of Track</label
                    >
                    <div class="col-sm-9">
              ...
              <div class="col-md-6">
                <div class="mb-2 border-bottom pb-2">
                  <div class="row align-items-center">
                    <label for="album" class="col-sm-3 col-form-label text-muted">UPC</label>
                    <div class="col-sm-9">
                      <span>{{ song.album.upc_code }}</span>
                    </div>
                  </div>
                </div>
                <div class="mb-2 border-bottom pb-2">
                  <div class="row align-items-center">
                    <label for="composer" class="col-sm-3 col-form-label text-muted"
                      >Language</label
                    >
                    <div class="col-sm-9">
                      <input
                ...
                <div class="mb-2 border-bottom pb-2">
                  <div class="row align-items-center">
                    <label for="label" class="col-sm-3 col-form-label text-muted"
                      >Over 25th years</label
                    >
                    <div class="col-sm-9">
                      <input
                        type="text"
                ...
                <div class="mb-2 border-bottom pb-2">
                  <div class="row align-items-center">
                    <label for="master" class="col-sm-3 col-form-label text-muted"
                      >Release Date</label
                    >
                    <div class="col-sm-9">
                      <span>{{ song.album.release_date }}</span>
                ...
                <div class="mb-2 border-bottom pb-2">
                  <div class="row align-items-center">
                    ...
                    >
                    <div class="col-sm-9">
                      <span>{{ song.royalty_contract }}</span>
                    </div>
                  </div>
                </div>
              </div>
