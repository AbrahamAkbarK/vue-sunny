          ...
          <div class="bg-white p-4 p-md-5 rounded-3">
            <div class="row g-4">
              ...
              <div class="col-md-6">
                  ...
                  <div class="row align-items-center">
                    ...
                    <div class="col-sm-9">
                      <input
                        type="text"
                        id="title"
                        value="https://music.apple.com/us/playlist/top-25-new-york-city/pl.a88b5c26caea48a59484370b6f79c9df"
                        class="form-control-plaintext"
                        readonly
                      />
                    </div>
                ...
                <div class="mb-2 border-bottom pb-2">
                  <div class="row align-items-center">
                    <label for="artist" class="col-sm-3 col-form-label text-muted">Spotify</label>
                    <div class="col-sm-9">
                      <input
                        type="text"
                        id="artist"
                        value="https://open.spotify.com/album/1DAuVHMlBvIjzWZALSUXbn"
                        class="form-control-plaintext"
                        readonly
                      />
                    </div>
                ...
                <div class="mb-2 border-bottom pb-2">
                  <div class="row align-items-center">
                    <label for="genre" class="col-sm-3 col-form-label text-muted">Tiktok</label>
                    <div class="col-sm-9">
                      <input
                        type="text"
                        id="genre"
                        value="https://www.tiktok.com/search?q=alan%20walker%20song&t=1756433918755"
                        class="form-control-plaintext"
                        readonly
                      />
                    </div>
              ...
              <div class="col-md-6">
                <div class="mb-4 border-bottom pb-2">
                  <div class="row align-items-center">
                    <label for="album" class="col-sm-3 col-form-label text-muted"
                      >Langit Musik</label
                    >
                    <div class="col-sm-9">
                      <input
                ...
                <div class="mb-4 border-bottom pb-2">
                  <div class="row align-items-center">
                    <label for="label" class="col-sm-3 col-form-label text-muted">Trebel</label>
                    <div class="col-sm-9">
                      <input
                        type="text"
                        id="label"
